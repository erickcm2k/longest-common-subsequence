...
const ImplementationsText = () => {
  return (
      ...
      <Flex flexDir={['column', 'column', 'column', 'row']} pt="5" justifyContent="space-evenly">
          <Box alignSelf={['inherit','inherit','inherit','center']} py={["4","4","4","0"]}>
              <Text fontSize={['lg','lg', 'xl', '2xl']} color='brand.regalBlue' fontWeight='bold'>Implementaciones en C++</Text>
          </Box>
          <Box maxW={["sm", "sm", "lg", "3xl"]} alignSelf={['center','center','flex-end','flex-end']}>
